...
<?php include 'menus.php'; ?>
  ...
  <tr>
    ...
    <select name="Date_of_Arrival" id="Date_of_Arrival" class="f_select_text">
    ...
    <td align="left" valign="middle">
    <select name="Month_of_Arrival" id="Month_of_Arrival" class="f_select_text">
    ...
    <td align="left" valign="middle">
    <select name="Year_of_Arrival" id="Year_of_Arrival" class="f_select_text">
      ...
      <option value="2020">2020</option>
        ...
        <td width="29%" align="left" valign="middle"><table width="90%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <select name="Date_of_Departure" id="Date_of_Departure" class="f_select_text">
                <option value="1" >1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">4</option>
              ...
              &nbsp;&nbsp;</td>
            <td align="left" valign="middle">
            <select name="Month_of_Departure" id="Month_of_Departure" class="f_select_text">
                <option value="January">Jan</option>
                <option value="Febuary">Feb</option>
                <option value="March">Mar</option>
                <option value="April">Apr</option>
              ...
              &nbsp;&nbsp;</td>
            <td align="left" valign="middle">
            <select name="Year_of_Departure" id="Year_of_Departure" class="f_select_text">
               <option value="2015" selected="selected">2015</option>
                <option value="2016">2016</option>
                <option value="2017">2017</option>
                <option value="2018">2018</option>
      ...
      <tr>
        ...
        <td align="left" valign="middle">
        <input size="10" type="text" name="childrens" id="childrens" class="f_textfiled" />
        </td>
      </tr>
       <tr>
        <td height="10" align="left" valign="middle"> </td>
      ...
      <tr>
        <td align="left" valign="middle">Budget Per Day :</td>
        <td align="left" valign="middle">
        <select name="Budget_Per_Person_Per_Day" id="Budget_Per_Person_Per_Day" class="f_select_text">
        ...
        <select class="f_select_text" id="Hotel_Category" size="1" name="Hotel_Category">
      ...
      <tr>
        <td height="25" align="left" valign="middle">Aslo Interested Themes : </td>
  ...
  <tr>
    <td align="left" valign="middle">
    <input type="checkbox" value="Beaches" id="Beaches" name="Beaches"/></td>
    <td align="left" valign="middle">Beaches&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
</table>        </td>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Cultural" id="Cultural" name="Cultural"/></td>
            <td align="left" valign="middle">Cultural&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
        </table>        </td>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Safari" id="Safari" name="Safari"/></td>
            <td align="left" valign="middle"> Desert 
        ...
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Hill Stations" id="hs" name="hs"/></td>
            <td align="left" valign="middle"> Hill Stations </td>
          </tr>
        </table>        </td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Forts / Palaces" id="fort" name="fort"/></td>
            <td align="left" valign="middle">Forts/Palaces&nbsp;&nbsp;&nbsp;</td>
          </tr>
        </table>        </td>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Himalayas" id="Himalayas" name="Himalayas"/></td>
            <td align="left" valign="middle">Himalayas&nbsp;</td>
          </tr>
        </table>        </td>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Temples" id="Temples" name="Temples"/></td>
            <td align="left" valign="middle">Temples</td>
          </tr>
        </table>        </td>
        <td height="25" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle">
            <input type="checkbox" value="Yoga/Meditation/Ayurveda"  id="yoga" name="yoga"/></td>
            <td align="left" valign="middle">Yoga/Meditation/Ayurveda </td>
          </tr>
        </table>        </td>
      </tr>
       <tr>
  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t_text">
      <tr>
        ...
        E-mail:
        <input name="useremail" id="useremail" type="text" class="f_textfiled"/></td>
      </tr>
      <tr>
        <td height="10" align="left" valign="middle"></td>
        <td height="10" align="left" valign="middle"></td>
  ...
  <tr>
    ...
    <td  height="25" align="left" valign="top"> <input id="fc_submit" class="btn_b" type="submit" name="fc_submit" tabindex="5" value="Submit Query" /> </td>
  </tr>
</table></td>
  </tr>
</table>
